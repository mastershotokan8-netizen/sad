...
export default function DisplayAppearance() {
  ...
  return (
    <div className="h-full flex flex-col bg-[#fdfaf8]">
      <div className="flex items-center gap-4 px-6 py-5 bg-white z-10 sticky top-0 shadow-sm border-b border-gray-100">
        ...
        <span className="text-lg font-bold text-slate-900">Display & Appearance</span>
      </div>
      <div className="p-6">
        <p className="text-slate-500">Display and appearance settings will go here.</p>
      </div>
    </div>
  );
}
